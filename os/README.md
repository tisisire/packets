...
```
Εάν η κλήση Open (Άνοιξε), αποτύχει, η συμβολοσειρά σφάλματος που θα εμφανιστεί θα είναι αυτοεπεξηγηματική.
```bash
    open file.go: no such file or directory
```

Εάν είναι πετυχημένη η κλήση, τα δεδομένα του αρχείο μπορούν να διαβαστούν ως μια φέτα (slice) από ψηφιολέξεις (bytes). Η Read (Διάβασε) και η Write (Γράψε), απαριθμούν bytes, σύμφωνα με την χωρητικότητα της φέτας, όπως έχει ορισθεί.
